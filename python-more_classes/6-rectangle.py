...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            String representation using '#' character
    ...
    def __del__(self):
        """Destructor - called when the rectangle instance is deleted

        Prints a farewell message and decrements the instance counter
        """
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
